...
import OrchestrateSvg from "../svg/orchestrate.svg"
import ExecuteSvg from "../svg/execution.svg"
        ...
        <Grid lg={2}>
          ...
          <div className="relative flex py-24 justify-end lg:py-0 lg:justify-center">
            {page.frontmatter.order === 1 && (
              <OrchestrateSvg className="absolute -bottom-14 lg:-bottom-24 h-auto w-80 max-w-full md:w-3/5 lg:w-4/5 xl:w-3/6" />
            )}
            {page.frontmatter.order === 2 && (
              <ExecuteSvg className="absolute -bottom-16 lg:-bottom-32 h-auto w-64 max-w-full md:w-2/5 lg:w-4/5 xl:w-3/6" />
            )}
            {page.frontmatter.order === 3 && (
              <DataSvg className="absolute -bottom-14 lg:-bottom-28 h-auto w-48 max-w-full md:w-2/5 lg:w-3/5 xl:w-2/5" />
            )}
          </div>
        </Grid>
      </HeroWrapper>
